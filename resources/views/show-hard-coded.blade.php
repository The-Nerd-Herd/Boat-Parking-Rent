            ...
            <div class="flex flex-col lg:h-[600px] lg:w-[1000px] justify-between">
                ...
                <div
                    ...
                    <table>
                        ...
                        <tr class="border-b-2 border-t-0">
                            <td class="bg-white text-left">Ligplaats buiten ponton van langssteiger 10% opslag over
                                totaal
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <table>
                        ...
                        <tr class="border-b-2 border-t-0">
                            <td class="bg-white text-left">Voor een ligplaatsaanvraag neemt u contact op met Hoop
                                Maritiem BV
                            </td>
                        </tr>
                        <tr class="border-b-2 border-t-0">
                            <td class="bg-white text-left">
                                ...
                                Het is raadzaam om direct contact op te nemen met Hoop Maritiem BV voor de meest actuele
